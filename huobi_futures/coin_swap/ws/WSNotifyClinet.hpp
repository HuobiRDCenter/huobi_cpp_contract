#include "huobi_futures/coin_swap/ws/WebSocketOp.hpp"

#include "huobi_futures/coin_swap/ws/response/notify/SubAccountsResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubAccountsResponse SubAccountsResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubOrdersResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubOrdersResponse SubOrdersResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubPositionsResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubPositionsResponse SubPositionsResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubMatchOrdersResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubMatchOrdersResponse SubMatchOrdersResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubLiquidationOrdersResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubLiquidationOrdersResponse SubLiquidationOrdersResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubFundingRateResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubFundingRateResponse SubFundingRateResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubContractInfoResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubContractInfoResponse SubContractInfoResponse;

#include "huobi_futures/coin_swap/ws/response/notify/SubTriggerOrderResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_notify::SubTriggerOrderResponse SubTriggerOrderResponse;
        ...
        namespace ws
        {
            ...
            public:
                NotifyClient(const string &access_key, const string &secret_key, const string &host = utils::DEFAULT_HOST)
                    : WebSocketOp("/swap-notification", host, access_key, secret_key)
                {
                    Connect();
                }
