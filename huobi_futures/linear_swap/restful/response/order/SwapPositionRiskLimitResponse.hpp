...
namespace huobi_futures
{
    namespace linear_swap
    {
        namespace restful
        {
            ...
            {
                struct SwapPositionRiskLimitResponse
                {
                    ...
                    struct Data
                    {
                        ...
                        JS_OBJ(contract_code, contract_type, margin_mode, position_side, max_lever, maintenance_margin_rate, max_volume, min_volume);
                    };
