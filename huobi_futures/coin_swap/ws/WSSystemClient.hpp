...
#include "huobi_futures/coin_swap/ws/response/system/SubHeartbeatResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_system::SubHeartbeatResponse SubHeartbeatResponse;
