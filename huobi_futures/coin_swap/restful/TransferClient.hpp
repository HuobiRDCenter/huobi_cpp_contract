...
#include "huobi_futures/coin_swap/restful/response/transfer/TransferResponse.hpp"
typedef huobi_futures::coin_swap::restful::response_transfer::TransferResponse TransferResponse;
