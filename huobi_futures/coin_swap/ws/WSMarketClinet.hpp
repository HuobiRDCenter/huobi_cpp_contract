...
#include "huobi_futures/coin_swap/ws/response/market/SubKLineResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::SubKLineResponse SubKLineResponse;

#include "huobi_futures/coin_swap/ws/response/market/ReqKLineResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::ReqKLineResponse ReqKLineResponse;

#include "huobi_futures/coin_swap/ws/response/market/SubDepthResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::SubDepthResponse SubDepthResponse;

#include "huobi_futures/coin_swap/ws/response/market/SubBboResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::SubBboResponse SubBboResponse;

#include "huobi_futures/coin_swap/ws/response/market/ReqTradeDetailResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::ReqTradeDetailResponse ReqTradeDetailResponse;

#include "huobi_futures/coin_swap/ws/response/market/SubTradeDetailResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::SubTradeDetailResponse SubTradeDetailResponse;

#include "huobi_futures/coin_swap/ws/response/market/SubMarketDetailResponse.hpp"
typedef huobi_futures::coin_swap::ws::response_market::SubMarketDetailResponse SubMarketDetailResponse;
...
namespace huobi_futures
{
    namespace coin_swap
    {
        namespace ws
        {
            ...
            {
            public:
                WSMarketClient(const string &host = utils::DEFAULT_HOST) : WebSocketOp("/swap-ws", host)
                {
                    Connect();
                }
