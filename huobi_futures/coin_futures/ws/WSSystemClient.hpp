...
#include "huobi_futures/coin_futures/ws/response/system/SubHeartbeatResponse.hpp"
typedef huobi_futures::coin_futures::ws::response_system::SubHeartbeatResponse SubHeartbeatResponse;
